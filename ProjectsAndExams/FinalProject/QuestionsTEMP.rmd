...
1. What is mood across different types of artist
1. How does order of soundtrack for movies affect mood
1. Can we recommend similar songs to a user given a specific artist?
...
1. Can we predict the liveness of the track based on its characteristics?
1. Can we predict if someone would like a track given their music tastes?
1. Can we predict if a track is major or minor given it's other characteristics?
1. Can we predict if a song is explicit given its title, artist, and characteristics?
1. Can we predict the energy of the track given its characteristics?
...
1. Can we recommend similar songs to a user given a specific artist?
1. Can we classify the songs into different "contexts" in which they would be played?
